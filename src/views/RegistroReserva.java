...
public class RegistroReserva extends JFrame {
	...
	public RegistroReserva() {
		...
		lblCheckIn.setBounds(68, 136, 230, 14);
		lblCheckIn.setFont(new Font("Roboto Black", Font.PLAIN, 18));
		panel.add(lblCheckIn);

		JLabel lblCheckOut = new JLabel("FECHA DE CHECK OUT");
		lblCheckOut.setForeground(SystemColor.textInactiveText);
		lblCheckOut.setBounds(68, 221, 248, 14);
		...
		lblValor.setBounds(72, 303, 226, 14);
		...
		JLabel txtValor = new JLabel("");
		txtValor.setForeground(new Color(0, 128, 255));
		txtValor.setFont(new Font("Dialog", Font.BOLD, 16));
		txtValor.setBounds(68, 328, 289, 44);
		panel.add(txtValor);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Reserva reserva = validarDatos(txtFechaEntrada, txtFechaSalida, txtFormaPago, txtValor);
				if (reserva != null) {
					guardarDatos(reserva);
		...
		btnNewButton.setBounds(221, 494, 132, 35);
		panel.add(btnNewButton);

	}

	private Reserva validarDatos(JDateChooser txtFechaEntrada, JDateChooser txtFechaSalida,
			JComboBox<String> txtFormaPago, JLabel txtValor) {
		...
		try {
			...
			if (fechaEntrada == null || fechaSalida == null) {
				throw new RuntimeException("Por favor registre las fechas");
			}
			...
			return new Reserva(fechaEntrada, fechaSalida, formaPago, valor);
		} catch (Exception e) {
	...
	private void guardarDatos(Reserva reserva) {
