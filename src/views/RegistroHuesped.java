...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		textField.setBounds(576, 150, 255, 33);
		contentPane.add(textField);
		
		textField_1 = new JTextField();
		textField_1.setColumns(10);
		textField_1.setBackground(Color.WHITE);
		textField_1.setBounds(576, 217, 255, 33);
		contentPane.add(textField_1);
		
		JDateChooser FechaE = new JDateChooser();
		FechaE.setBounds(576, 281, 255, 33);
		...
		comboBox.setBounds(576, 350, 255, 33);
		...
		textField_2.setBounds(576, 419, 255, 33);
		...
		textField_3.setBounds(576, 480, 255, 33);
