...
public class RegistroHuesped extends JFrame {
	 ...
	 * RegistroHuesped(); frame.setVisible(true); } catch (Exception e) {
	 * e.printStackTrace(); } } }); }
	 */
	...
	private void guardar(Reserva reserva) {
		if (txtNombre.getText().isBlank() || txtApellido.getText().isBlank() || txtTelefono.getText().isBlank()) {
			JOptionPane.showMessageDialog(this, "Los campos Nombre, Apellido y Teléfono son requeridos.");
            return;
		}
		
		Huesped huesped = new Huesped(reserva, txtNombre.getText().toString(), txtApellido.getText().toString(),
				txtFechaN.getDate(), txtNacionalidad.getSelectedItem().toString(),
